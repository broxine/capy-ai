...
The autopatch planner is the bridge from theory to controlled change: it proposes how scoring and skills should move next, but still keeps humans in charge of applying those mutations.
